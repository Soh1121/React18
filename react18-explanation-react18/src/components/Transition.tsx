...
export const Transition = () => {
    ...
    return (
        <div>
            ...
            <br />
            <button type="button" onClick={() => onClickAssignee('')}>リセット</button>
            <br />
            <br />
            <button type="button" onClick={() => setIsShowList(!isShowList)}>表示/非表示</button>
            {isShowList && <TaskList taskList={taskList} />}s
        </div>
    );
};
