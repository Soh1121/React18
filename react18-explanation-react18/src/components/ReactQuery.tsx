    ...
    return (
        <div style={{ display: "flex", padding: "16px" }}>
            ...
            <div style={{ flexGrow: 1 }}>
                <button type="button" style={todoButtonStyle} onClick={() => onClickTabButton("todo")}>Todo</button>
                <button type="button" style={albumButtonStyle} onClick={() => onClickTabButton("album")}>Album</button>
